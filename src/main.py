...
DEFAULT_SOLUTION_VERTICES = [24]        # [] # for multidirectional search on cubes
...
DEFAULT_PREFIX_SET = 3              # None # 2 # 3 # 4 # comparing sets of states with same prefix of length k-3
